...
export default function GamesTab({ 
  ...
  return (
    <div className="w-full pb-6 animate-fade-in text-on-surface">
      ...
      <div className="sticky top-0 z-30 -mx-5 mb-6 bg-background px-5 pb-3 pt-0 shadow-[0_12px_18px_-18px_rgba(0,0,0,.9)]"><div className="flex gap-2.5 overflow-x-auto no-scrollbar pb-1">
        <button
